...
type PingDest struct {
	...
	Updatetime  int32             `protobuf:"varint,3,opt,name=updatetime,proto3" json:"updatetime,omitempty"`                                                                                //Time of the creation or update time.
	Timeout     int32             `protobuf:"varint,4,opt,name=timeout,proto3" json:"timeout,omitempty"`                                                                                      //Max run time in nano seconds allowed for that monitoring object.
	Interval    int32             `protobuf:"varint,5,opt,name=interval,proto3" json:"interval,omitempty"`                                                                                    //Probe interval in micro seconds
	PacketSize  int32             `protobuf:"varint,6,opt,name=packetSize,proto3" json:"packetSize,omitempty"`                                                                                //Packet size to be used by probe
	Ttl         int32             `protobuf:"varint,7,opt,name=ttl,proto3" json:"ttl,omitempty"`                                                                                              //TTL of the ip packet
	Groups      map[string]string `protobuf:"bytes,8,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //Member groups
}
...
type ResolveDest struct {
	...
	Updatetime    int32             `protobuf:"varint,3,opt,name=updatetime,proto3" json:"updatetime,omitempty"`                                                                                //Time of the creation or update time.
	Timeout       int32             `protobuf:"varint,4,opt,name=timeout,proto3" json:"timeout,omitempty"`                                                                                      //Max run time in nano allowed for that monitoring object.
	ResolveServer string            `protobuf:"bytes,5,opt,name=resolveServer,proto3" json:"resolveServer,omitempty"`                                                                           //DNS Server to be used, 8.8.8.8 e.t.c
	Interval      int32             `protobuf:"varint,6,opt,name=interval,proto3" json:"interval,omitempty"`                                                                                    //Probe interval in micro seconds
...
type AppDest struct {
	...
	Updatetime  int32             `protobuf:"varint,3,opt,name=updatetime,proto3" json:"updatetime,omitempty"`  //Time of the creation or update time.
	Timeout     int32             `protobuf:"varint,4,opt,name=timeout,proto3" json:"timeout,omitempty"`        //Max run time in seconds allowed for that monitoring object.
	Type        AppDest_Type      `protobuf:"varint,5,opt,name=type,proto3,enum=api.AppDest_Type" json:"type,omitempty"`
	Interval    int32             `protobuf:"varint,6,opt,name=interval,proto3" json:"interval,omitempty"`                                                                                    //Prove interval in micro seconds
	Groups      map[string]string `protobuf:"bytes,7,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //Member groups
}
...
var file_api_nmon_proto_rawDesc = []byte{
	...
	0x42, 0x08, 0x0a, 0x06, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0xb6, 0x02, 0x0a, 0x08, 0x50,
	0x69, 0x6e, 0x67, 0x44, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	,
	...
	0x02, 0x38, 0x01, 0x22, 0xb8, 0x02, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x65, 0x44, 0x65, 0x73,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x75, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f,
	...
	0x01, 0x28, 0x05, 0x52, 0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x1e, 0x0a,
	0x0a, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x53, 0x69, 0x7a, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0a, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x10, 0x0a,
	...
	0x1a, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x65, 0x44, 0x65, 0x73, 0x74, 0x2e,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x73, 0x1a, 0x39, 0x0a, 0x0b, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb0,
	0x02, 0x0a, 0x0b, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x44, 0x65, 0x73, 0x74, 0x12, 0x12,
	...
	,
	...
	0x01, 0x22, 0xd0, 0x02, 0x0a, 0x07, 0x41, 0x70, 0x70, 0x44, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x74,
	0x69, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x25, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x61, 0x70,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	0x12, 0x30, 0x0a, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b,
